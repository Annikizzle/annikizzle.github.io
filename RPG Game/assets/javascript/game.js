...
$(document).ready(function () {
  ...
  var castamere = new Audio('assets/audio/castamere.mp3');
  var sword1 = new Audio('assets/audio/sword1.mp3');
  var sword2 = new Audio('assets/audio/sword2.mp3');
  var sword3 = new Audio('assets/audio/sword3.mp3');
  var laugh = new Audio('assets/audio/laugh.mp3');
  ...
  var characters = {
    'Arya': {
      ...
      health: 150,
      attack: 10,
      imageUrl: "assets/images/arya.png",
      enemyAttackBack: 15,
    },
    'Brienne': {
      name: 'Brienne',
      health: 200,
      attack: 9,
      imageUrl: "assets/images/brienne.png",
      enemyAttackBack: 20,
    },
    'Cersei': {
      name: 'Cersei',
      health: 180,
      attack: 8,
      imageUrl: "assets/images/cersei.png",
      enemyAttackBack: 20,
    },
    'Jaime': {
      name: 'Jaime',
      health: 180,
      attack: 9,
      imageUrl: "assets/images/jaime.png",
      enemyAttackBack: 30,
    },
    'Jon Snow': {
      name: 'Jon Snow',
      health: 200,
      attack: 7,
      imageUrl: "assets/images/jonsnow.png",
      enemyAttackBack: 23,
    },
    'Daenerys': {
      name: 'Daenerys',
      health: 125,
      attack: 8,
      imageUrl: "assets/images/khaleesi.png",
      enemyAttackBack: 30,
    },
  };
  ...
  $(document).on('click', '.character', function () {
    ...
    if (!currSelectedCharacter) {
      ...
      //Renders all characters for user to choose fight against
    ...
    if ($('#defender').children().length !== 0) {
      ...
      if (currDefender.health > 0) {
        ...
        if (currSelectedCharacter.health <= 0) {
          renderMessage("clearMessage");
          restartGame("When you play the game of thrones, you win or you die. GAME OVER");
          castamere.play();
        ...
        if (killCount >= 3) {
          renderMessage("clearMessage");
          restartGame("What do we say to the God of death? Not today! YOU WIN");
          sword1.play();
          // Theme Song Plays
          setTimeout(function () {
            theme.play();
      ...
      renderMessage("clearMessage");
      renderMessage("Are you drunk? There's no one here.");
      laugh.play();
    }
  });
